...
class DataIngestion:
    ...
    def split_data_train_and_test(self) -> DataIngestionArtifact:
        try:
            raw_data_dir = self.data_ingestion_config.raw_data_dir
            ...
            if strat_test_set is not None:
                ...
                logging.info(f"Exporting test dataset to file:[{train_file_path}]")
    ...
    def intiate_data_ingestion(self) -> DataIngestionArtifact:
        try:
            ...
            return self.split_data_train_and_test()
